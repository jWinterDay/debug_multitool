...
class DiffNode {
  ...
  void forAllAdded(void Function(Object k, Object o) ffn, {Map<Object, Object> root = const {}}) {
    added.forEach((key, thisNode) => ffn(root, thisNode));
    node.forEach((key, node) {
      root[key] = <String, Object>{};
      node.forAllAdded((addedMap, root) => ffn(root, addedMap), root: root[key] as Map<String, Object>);
    });
  }
  ...
  bool get hasNothing => added.isEmpty && removed.isEmpty && changed.isEmpty && moved.isEmpty && node.isEmpty;
