...
class ConnectEvent {
  ...
  static ConnectEvent from(
    proto.ConnectResult result,
  ) =>
      ConnectEvent(
        result.client,
        result.version,
...
class JoinEvent {
  ...
  static JoinEvent from(proto.ClientInfo clientInfo) => JoinEvent(
        clientInfo.user,
        clientInfo.client,
      );
...
class LeaveEvent {
  ...
  static LeaveEvent from(proto.ClientInfo clientInfo) => LeaveEvent(
        clientInfo.user,
        clientInfo.client,
      );
